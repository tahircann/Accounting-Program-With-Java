...
public class KullaniciGirisi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("kullanıcıadı:admin");

        jLabel4.setText("şifre:12345");

        jLabel5.setText("Hocam denemeniz için:");
    ...
    private void girisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_girisActionPerformed
        ...
        if (kullanici_adi.equals("admin") && parola.equals("12345")) {
            ...
            tumIslemler tumIslemler1 = new tumIslemler(); // diğer ana frame e geçiş
            tumIslemler1.setVisible(true);
